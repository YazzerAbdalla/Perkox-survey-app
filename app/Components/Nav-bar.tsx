  ...
  return (
      <div className="w-full z-[1500] items-center">
          ...
          >
              <div className="flex items-center">
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                      {window.innerWidth <= 768 ? (
                          <Link href="" onClick={() => handleLinkClick("Home")} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                              <Image
                                  src="/perkox-logo-1.png"  // Provide the path to the mobile image
                                  alt="Mobile-Logo"
                                  width={65}
                                  height={50}
                                  style={{ fontSize: '30px', textTransform: 'uppercase', color: 'white', backgroundImage: 'url(/Mobile-Logo.png)' }}
                              />
                          </Link>
              ...
              <ul
                  className={`w-full pb-12  absolute md:flex md:items-center md:pb-0 md:static z-1 md:w-auto md:pl-0 pl-9 transition-all duration-500 ease top-[4.4rem] ${
