...
const Navbar = () => {
  ...
  return (
    <div className="w-full mt-0 h-[65px] mb-5 fixed top-0 shadow-lg shadow-[#ffa4eb]/50 bg-[#03001417] backdrop-blur-md z-[1000] sm:px-10">
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px] relative">
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full right-0 bg-white z-50 border-b border-[#7042f861] h-screen flex items-center justify-center">
            <div className="flex items-top justify-top h-full">
              <div className="flex flex-col items-end text-black">
                <Link
                  href="/"
                  className="py-2 px-4 cursor-pointer border-b border-black flex items-center"
                  onClick={toggleMenu}
                >
                  {/* Home SVG */}
                  <div className="mr-2">
